...
export namespace Prisma {
  ...
  */
    ...
    model: {
      ...
      JobRun: {
        ...
        operations: {
          ...
          findRaw: {
            args: Prisma.JobRunFindRawArgs<ExtArgs>
            result: JsonObject
          }
          aggregateRaw: {
            args: Prisma.JobRunAggregateRawArgs<ExtArgs>
            result: JsonObject
          }
          count: {
  ...
  export type JobOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "name" | "image" | "command" | "env" | "schedule" | "timeout" | "retries" | "createdAt" | "updatedAt", ExtArgs["result"]["job"]>
  ...
  interface JobFieldRefs {
    ...
    readonly schedule: FieldRef<"Job", 'String'>
    readonly timeout: FieldRef<"Job", 'Int'>
    readonly retries: FieldRef<"Job", 'Int'>
  ...
  export type JobRunOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "jobId" | "status" | "logs" | "exitCode" | "startedAt" | "endedAt", ExtArgs["result"]["jobRun"]>
  ...
  export interface JobRunDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    ...
    /**
     * Find zero or more JobRuns that matches the filter.
     * @param {JobRunFindRawArgs} args - Select which filters you would like to apply.
     * @example
     * const jobRun = await prisma.jobRun.findRaw({
     *   filter: { age: { $gt: 25 } }
     * })
     */
    findRaw(args?: JobRunFindRawArgs): Prisma.PrismaPromise<JsonObject>

    /**
     * Perform aggregation operations on a JobRun.
     * @param {JobRunAggregateRawArgs} args - Select which aggregations you would like to apply.
     * @example
     * const jobRun = await prisma.jobRun.aggregateRaw({
     *   pipeline: [
     *     { $match: { status: "registered" } },
     *     { $group: { _id: "$country", total: { $sum: 1 } } }
     *   ]
     * })
     */
    aggregateRaw(args?: JobRunAggregateRawArgs): Prisma.PrismaPromise<JsonObject>
  ...
  interface JobRunFieldRefs {
    ...
    readonly logs: FieldRef<"JobRun", 'String'>
    readonly exitCode: FieldRef<"JobRun", 'Int'>
   ...
   * JobRun findRaw
   */
  export type JobRunFindRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
     * The query predicate filter. If unspecified, then all documents in the collection will match the predicate. ${@link https://docs.mongodb.com/manual/reference/operator/query MongoDB Docs}.
     */
    filter?: InputJsonValue
   ...
   * JobRun aggregateRaw
   */
  export type JobRunAggregateRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
     * An array of aggregation stages to process and transform the document stream via the aggregation pipeline. ${@link https://docs.mongodb.com/manual/reference/operator/aggregation-pipeline MongoDB Docs}.
     */
    pipeline?: InputJsonValue[]
  ...
  export type JobWhereInput = {
    ...
    command?: StringNullableListFilter<"Job">
    env?: JsonFilter<"Job">
    schedule?: StringNullableFilter<"Job"> | string | null
    timeout?: IntNullableFilter<"Job"> | number | null
    retries?: IntNullableFilter<"Job"> | number | null
  ...
  export type JobScalarWhereWithAggregatesInput = {
    ...
    command?: StringNullableListFilter<"Job">
    env?: JsonWithAggregatesFilter<"Job">
    schedule?: StringNullableWithAggregatesFilter<"Job"> | string | null
    timeout?: IntNullableWithAggregatesFilter<"Job"> | number | null
    retries?: IntNullableWithAggregatesFilter<"Job"> | number | null
  ...
  export type JobRunWhereInput = {
    ...
    logs?: StringFilter<"JobRun"> | string
    exitCode?: IntFilter<"JobRun"> | number
  ...
  export type JobRunScalarWhereWithAggregatesInput = {
    ...
    logs?: StringWithAggregatesFilter<"JobRun"> | string
    exitCode?: IntWithAggregatesFilter<"JobRun"> | number
  ...
  export type JobCreateInput = {
    ...
    name: string
    image: string
    command?: JobCreatecommandInput | string[]
    env: InputJsonValue
    schedule?: string | null
    timeout?: number | null
    retries?: number | null
  ...
  export type JobUpdateInput = {
    ...
    command?: JobUpdatecommandInput | string[]
    env?: InputJsonValue | InputJsonValue
  ...
  export type JobCreatecommandInput = {
    set: string[]
  }
  ...
  export type JobUpdatecommandInput = {
    set?: string[]
    push?: string | string[]
  }
